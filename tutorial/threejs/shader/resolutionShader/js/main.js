...
(function(window) {
	...
	Main.prototype.updateResolution = function() {
		this.cube.children[0].material.uniforms.resolution.value.x = this.getCanvasWidth();
		this.cube.children[0].material.uniforms.resolution.value.y = this.getCanvasHeight();
	};
