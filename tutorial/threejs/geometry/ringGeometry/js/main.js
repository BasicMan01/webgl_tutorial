...
(function(window) {
	...
	Main.prototype.createGui = function() {
		...
		let folderGeometry = this.gui.addFolder('Ring Geometry');
		...
		let folderMaterial = this.gui.addFolder('Ring Material');
		folderMaterial.addColor(properties, 'ringMaterialColor').onChange(function(value) {
			self.ring.children[0].material.color.set(value);
		});
		folderMaterial.addColor(properties, 'ringWireframeColor').onChange(function(value) {
			self.ring.children[1].material.color.set(value);
		});

		let folderTransformation = this.gui.addFolder('Ring Transformation');
