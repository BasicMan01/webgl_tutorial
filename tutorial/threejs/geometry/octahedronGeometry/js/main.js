...
(function(window) {
	...
	Main.prototype.createGui = function() {
		...
		var folderGeometry = this.gui.addFolder('Octahedron Geometry');
		...
		var folderMaterial = this.gui.addFolder('Octahedron Material');
		folderMaterial.addColor(properties, 'octahedronMaterialColor').onChange(function(value) {
			self.octahedron.children[0].material.color.setHex(rdo.helper.cssColorToHex(value));
		});
		folderMaterial.addColor(properties, 'octahedronWireframeColor').onChange(function(value) {
			self.octahedron.children[1].material.color.setHex(rdo.helper.cssColorToHex(value));
		});

		var folderTransformation = this.gui.addFolder('Octahedron Transformation');
