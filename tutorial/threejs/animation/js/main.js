...
(function(window) {
	...
	Main.prototype.createObject = function() {
		...
		fbxLoader.load('../../../resources/mesh/fbx/fbxAnimation.fbx', function(object) {
			self.fbxModel = object;

			console.log(self.fbxModel);

			self.scene.add(self.fbxModel);

			self.mixer = new THREE.AnimationMixer(self.fbxModel);
	...
	Main.prototype.startClip = function(idx) {
		this.mixer.clipAction(this.fbxModel.animations[idx]).play();
	};

	Main.prototype.stopClip = function(idx) {
		this.mixer.clipAction(this.fbxModel.animations[idx]).stop();
	};
	...
	window.main = new Main(document.getElementById('webGlCanvas'));
