...
(function(window) {
	...
	let properties = {
		...
		'webCamAudio': false,
		'webCamVideo': true,
		'webCamVideoPlay': function() { document.getElementById('video').play(); },
		'webCamVideoPause': function() { document.getElementById('video').pause(); }
	};
	...
	Main.prototype.createGui = function() {
		...
		let folderVideo = this.gui.addFolder('Video Properties');
		folderVideo.add(properties, 'webCamAudio').onChange(function(value) {
			self.initVideo();
		});
		folderVideo.add(properties, 'webCamVideo').onChange(function(value) {
			self.initVideo();
		});
		folderVideo.add(properties, 'webCamVideoPlay');
		folderVideo.add(properties, 'webCamVideoPause');
	};
