...
(function(window) {
	...
	Main.prototype.setCameraPositionByDeltaTime = function(deltaTime) {
		...
		this.cameraGroup.position.copy(pos);
		this.camera.matrix.lookAt(this.cameraGroup.position, lookAt, this.binormal);
		this.cameraGroup.rotation.setFromRotationMatrix(this.camera.matrix, this.camera.rotation.order);
	};
